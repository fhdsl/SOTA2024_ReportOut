...
ggsave(here("resources/plots/where_run.png"), plot = whereRunPlot) #set save size
...
ggsave(here("resources/plots/where_run_stratified.png"), plot = whereRunPlotStrat) #set save size
