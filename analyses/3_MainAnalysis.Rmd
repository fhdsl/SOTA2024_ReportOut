...
forumPlotRaw <- ggplot(forumdf,
                       aes(y = fct_rev(fct_infreq(AnVILSupportForum)), fill = UserType)) +
  geom_bar() + 
...
forumPlotRawStrat <- ggplot(forumdf,
                       aes(y = fct_rev(fct_infreq(AnVILSupportForum)), fill = UserTypeStratified)) +
  geom_bar() + 
  ggtitle("Have you ever read or posted in our AnVIL Support Forum?") +
  geom_text(
    aes(label = after_stat(..count..)), stat = "count",
